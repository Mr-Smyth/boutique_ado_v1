...
# FIRST CHECK IF DEVELOPMENT IS IN OS.ENVIRON TO DETERMINE WHICH EMAIL SETUP
# TO USE

# so if in development - we will log our emails in the console
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'boutiqueado@example.com'

# else we will use our gmail setup and keys in heroku
else:
